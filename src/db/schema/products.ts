import { pgTable, text, timestamp, unique, numeric, integer, check, index, foreignKey } from "drizzle-orm/pg-core";
...
export const products = pgTable("products", {
    ...
    sold: numeric("sold", {precision: 10, scale:3}).notNull().default("0"),
